                ...
                @foreach($users as $user)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-light js-tooltip-enabled" style="background-color: #008CBA;padding:10px;" href="{{ route('Admin.Editemployee', $user->id) }}" data-toggle="tooltip" title="{{__('users.edit')}}">
