    ...
    @endif
            <div class="js-wizard-validation block block text-right" style="width:100%;" >
                ...
                <ul class="nav nav-tabs nav-tabs-block nav-justified" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active"  data-toggle="tab" style="font-size:17px;margin-top:">إضافة صلاحية جديدة</a>
                    </li>
                </ul>
                <form class="js-wizard-validation-form" action="{{ route('Admin.addPermission') }}" method="POST" enctype="multipart/form-data" dir="rtl">
                    @csrf
