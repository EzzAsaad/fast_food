        ...
        <div class="block block-rounded block-themed mb-0" >
            ...
            <div class="block-content">
                <div class="p-sm-3 px-lg-4 py-lg-5 {{ App::isLocale('ar')? 'text-right' : 'text-left'  }}">
                    ...
                    <p class="text-muted" >
                    {{trans('sidebar.MenuSettingsInfo')}}

                    </p>
                    <form class="js-validation-signin { App::isLocale('ar')? 'text-right' : 'text-left'  }}" action="{{ route('Admin.storeNewMenu') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="py-3">
                            <div class="row">
                                <div class="col">
                                    <label for="">{{ trans('menu.arTitle') }}</label>
                                    <input type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="nameAr" required> <br>
                                </div>
                                <div class="col">
                                <label for=""> {{ trans('menu.enTitle') }} </label>
                                    <input type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="nameEn" required>  <br>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                        ...
                                        <input type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="link" required> <br>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <select type="text" class="form-control form-control-alt form-control-lg" id="login-username" name="status" required >
                                        <option value="1">{{trans('menu.statusOn')}}</option>
                                        <option value="0">{{trans('menu.statusOn')}}</option>
                                    </select>                                </div>
                            </div>
